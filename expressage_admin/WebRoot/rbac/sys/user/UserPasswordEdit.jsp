...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script>
			...
			function chkOldPassword(obj){
				var password = obj.value;
				var username = $('#username')[0].value;
				if(password == ""){
					    setErrorMessage(obj,"原始密码不能为空！");
        				return false;
				}else{
					$.post('sysUser!checkPassword.action',{'sysUser.username':username,'oldPassword':password},function(resp){	
						if(resp=="1"){
							//setErrorMessage(obj,"原始密码输入错误，请重新输入！");
							showErrorDlg("原始密码输入错误，请重新输入！");
	        				return false;
						}
							return true;
					});
    ...
    <body>
        <form id="editForm" name="editForm" method="post" action="sysUser!editPassword.action">
                ...
                <div class="ZB_ListBox" style="padding-left: 4px;padding-right: 4px;">
                    <div class="ZB_FormWarp">
                        ...
                        <div class="ZB_FormNav">
                            <ul>
                                <li class="c"><a href="#"><span>修改个人密码</span></a></li>
                            </ul>
                        </div>
                        ...
                        <div class="ZB_FormWarp2">
                            ...
                            <table width="100%" border="0" cellspacing="1" cellpadding="0" class="ZB_FormTable">
                                ...
                                <tr>
                                    <td class="gridtitle">原始密码：</td>
                                    <td class="gridbody">
                                        <div class="editField" style="width: 200px;">
                                            <s:password name="oldPassword" maxLength="16" cssClass="inp ipt-normal" />
                                        </div>   
                                        <w:validator id="validator1" controlToValidate="oldPassword" validateFunction="chkOldPassword"
                                                     ruleMessage="填写原始密码，6-16位" errorMessage="必须项，请填写" />                                     
                                    </td>
                                </tr>
