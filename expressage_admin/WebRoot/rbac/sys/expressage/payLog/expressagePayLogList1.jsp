...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script>
        	...
        	function listUser(){
        		$('#listForm').attr("action", "expressagePayLog!list1.action").submit();
    ...
    <body>
        <form id="listForm" name="listForm" method="post" action="expressagePayLog!list1.action" >
                ...
                <div class="ZB_ListBox">
                    <div class="ZB_FormWarp">
                        ...
                        <div class="ZB_FormNav">
                            <ul>
                                <li class="c"><a href="#"><span>当前位置:提现管理</span></a></li>
                            </ul>
                        </div>
                        <!--#########################工具栏#########################-->
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="1" class="ZB_List">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <td width="50"><w:thead title="银行名称" sortField="bankName" /></td>
                                        <td width="50"><w:thead title="银行卡号" sortField="bankCode" /></td>
                                ...
                                <tbody>
                                    <s:iterator value="page.result" status="st">
                                        <tr onmouseover="this.style.backgroundColor='#DFE8F7'" onmouseout="this.style.backgroundColor=''"> <td width="10" class="CNumber">
                                            ...
                                            <s:elseif test="type==9">优惠券抵扣</s:elseif>
                                            <s:else></s:else>
                                            </td>
                                            ...
                                            <td style="text-align: center;">
                                           		 <a title="修 改" href='expressagePayLog!input1.action?payId=<s:property value="payId" />'>
