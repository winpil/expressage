                    ...
                    <div class="ZB_FormWarp">
                        ...
                        <div class="ZB_FormWarp2">
                            ...
                            <table width="100%" border="0" cellspacing="1" cellpadding="0" class="ZB_FormTable">
                                ...
                                <tr>
                                    <td class="gridtitle">服务城市：</td>
                                    <td class="gridbody">
                                        <div class="editField">
                                            <s:textfield name="expressageCourier.area" cssClass="inp ipt-normal" maxlength="50"/>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="gridbody">
                                        <div class="editField">
                                            ...
                                            <s:hidden name="expressageCourier.latitude" />
                                         	...
                                         	<s:hidden name="expressageCourier.clientNumber" />
                                         	<s:hidden name="expressageCourier.clientPwd" />
                                        </div>
                                    </td>
                                </tr>
