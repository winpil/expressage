...
<html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <script src="../../js/frame/listform.js" ></script>
         ...
         <script>
        	function listExpressageCourier(){
        		$('#listForm').attr("action", "expressageText!list1.action").submit();	
        	}
    ...
    <body>
        <form id="listForm" name="listForm" method="post" action="expressageText!list1.action" >
                ...
                <div class="ZB_ListBox">
                    <div class="ZB_FormWarp">
                        ...
                        <div class="ZB_FormNav">
                            <ul>
                                <li class="c"><a href="#"><span>当前位置:抢单费配置管理</span></a></li>
                            </ul>
                        </div>
                        <!--#########################工具栏#########################-->
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="1" class="ZB_List">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <td width="80"><w:thead title="对应星级" sortField="status" /></td>
                                        <td width="80"><w:thead title="抢单费用" sortField="rank" /></td>
                                ...
                                <tbody>
                                    <s:iterator value="page.result" status="st">
                                        <tr onmouseover="this.style.backgroundColor='#DFE8F7'" onmouseout="this.style.backgroundColor=''">
                                            ...
                                            <td><s:if test="status==1">4、5星</s:if>
                                            	<s:elseif test="status==2">3星</s:elseif>
                                            	<s:elseif test="status==3">2星</s:elseif>
                                                <s:else></s:else> 
                                            </td>
                                            <td><s:property value="rank" />&nbsp;</td>
                                            <td><s:property value="createDate" />&nbsp;</td>
                                            <td style="text-align: center;">
                                           		 <a title="修 改" href='expressageText!input1.action?textId=<s:property value="textId" />'>
