...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <form id="editForm" name="editForm" method="post" action="expressageIdea!save3.action" enctype="multipart/form-data">
            <div>
                <!--页面内容部分 start-->
