...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script>
        	...
        	function listUser(){
        		$('#listForm').attr("action", "expressageIdea!list3.action").submit();
    ...
    <body>
        <form id="listForm" name="listForm" method="post" action="expressageIdea!list3.action" >
                    ...
                    <div class="ZB_FormWarp">
                        ...
                        <div class="ZB_FormFunctionBox">
                            ...
                            <div class="ZB_FormSearch">
                                ...
                                <s:select list="#{'':'全部','orderNo':'订单号','courierId.courierName':'快递员名称'}" listKey="key" listValue="value" name="searchName" />
                                    ...
                                    <s:iterator value="page.result" status="st">
                                        <tr onmouseover="this.style.backgroundColor='#DFE8F7'" onmouseout="this.style.backgroundColor=''"> <td width="20" class="CNumber">
                                            ...
                                            <td style="text-align: center;">
                                           		 <a title="修 改" href='expressageIdea!input.action?types=3&ideaId=<s:property value="id" />'>
