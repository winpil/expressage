                    ...
                    <div class="ZB_FormWarp">
                        ...
                        <div class="ZB_FormFunctionBox">
                            <!--#########################搜索框#########################-->
                            	...
                            	<s:iterator value="efList" status="st">
	                            	<div class="ZB_FormFunction">
		                                <div class="add"><a href="#" onclick="confirmDelete('expressageUser!setFavorable.action?type=<s:property value="fid" />')"><s:property value="fname" />元优惠券</a></div>
		                            </div>
                            	</s:iterator>
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="1" class="ZB_List">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <td width="50"><w:thead title="名称" sortField="userName" /></td>
                                        <td width="50"><w:thead title="手机" sortField="phone" /></td>
                                        <td width="50"><w:thead title="积分" sortField="validIntegral" /></td>
                                        <td width="40"><w:thead title="信誉度" sortField="reputation" /></td>
                                        <td width="50"><w:thead title="帐号状态" sortField="isLock" /></td>
