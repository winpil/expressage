                ...
                <div class="ZB_ListBox">
                    <div class="ZB_FormWarp">
                        ...
                        <div class="ZB_FormNav">
                            <ul>
                                <li class="c"><a href="#"><span>当前位置:优惠券配置</span></a></li>
                            </ul>
                        </div>
                        <!--#########################工具栏#########################-->
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="1" class="ZB_List">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <td width="50"><w:thead title="优惠券面值" sortField="fName" /></td>
                                        <td width="50"><w:thead title="概率" sortField="fValue" /></td>
                                ...
                                <tbody>
                                    <s:iterator value="page.result" status="st">
                                        <tr onmouseover="this.style.backgroundColor='#DFE8F7'" onmouseout="this.style.backgroundColor=''"> <td width="10" class="CNumber">
                                            ...
                                            <td><s:property value="fvalue" />&nbsp;</td>
                                            <td><s:property value="createDate" />&nbsp;</td>
                                            <td style="text-align: center;">
                                           		 <a title="修 改" href='expressageF!input.action?id=<s:property value="fid" />'>
