...
body {
	...
	<body style="height: 100%;">
		<div id="left" style="float: left; width: 80%; height: 100%">
			<iframe id="menulist" name="menulist" src="sysGroup!list.action?parentId=<%=groupId%>"
				style="width: 100%; height: 98%" frameborder="0"></iframe>
		</div>

		<div  id="right" style="float: right; width: 20%; height: 100%">
			<iframe id="menutree"  name="menutree" src="sysGroup!groupTree.action" frameborder="0"
