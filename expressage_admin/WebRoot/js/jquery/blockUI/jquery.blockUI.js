...
$.growlUI = function(title, message, timeout, onClose,divClassName,overlay) {
        if (divClassName == undefined) divClassName="growlUI";
	var $m = $('<div class="'+divClassName+'"></div>');
	...
	$.blockUI({
		...
		timeout: timeout, showOverlay: overlay,
		onUnblock: onClose, 
