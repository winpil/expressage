...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <form id="editForm" name="editForm" method="post" action="expressageCompany!save.action" enctype="multipart/form-data">
            <div>
                <!--页面内容部分 start-->
                        ...
                        <div class="ZB_FormWarp2">
                            ...
                            <table width="100%" border="0" cellspacing="1" cellpadding="0" class="ZB_FormTable">
                                <tr>
                                    ...
                                    <td class="gridbody">
                                        <div class="editField">
                                            <s:textfield name="expressageCompany.companyName" cssClass="inp ipt-normal" maxlength="20" />
                                             <s:if test="expressageCompany.companyId != null && expressageCompany.companyId != '' ">
                                             <s:hidden name="expressageCompany.companyId"/> </s:if>
                                             <s:hidden name="expressageCompany.remark"/> 
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="gridbody">
                                        <div class="editField">
                                        	<s:textfield name="expressageCompany.linkman" cssClass="inp ipt-normal" maxlength="20"/>
                                        </div>
                                    </td>
                                </tr>
                                 <tr>
                                    <td class="gridtitle">联系人电话：</td>
                                    <td class="gridbody">
                                        <div class="editField">
                                        	<s:textfield name="expressageCompany.phone" cssClass="inp ipt-normal" maxlength="20"/>
                                        </div>
                                    </td>
                                </tr>
                                 <tr>
                                    ...
                                    <td class="gridbody">
                                        <div class="editField">
                                        	<w:datepicker id="expressageCompany.createDate"  value="${expressageCompany.createDate}" />
                                        </div>
                                    </td>
                                </tr>
                            </table>
