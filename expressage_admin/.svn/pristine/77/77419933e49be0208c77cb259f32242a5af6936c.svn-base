                ...
                <div class="ZB_ListBox">
                    <div class="ZB_FormWarp">
                        ...
                        <div class="ZB_FormNav">
                            <ul>
                                <li class="c"><a href="#"><span>当前位置:模版管理</span></a></li>
                            </ul>
                        </div>
                        <!--#########################工具栏#########################-->
                        <div class="ZB_FormFunctionBox">
                            ...
                            <div class="ZB_FormFunction">
                                	<div class="add"><a href='expressageNoteTemp!input.action'>添加</a></div>
                                <div class="delete">
                                    <input type="hidden" id="ids" name="ids" />
                                     <a href="#" onclick="confirmDelete('expressageNoteTemp!delete.action')">删除</a>
                                </div>
                            </div>                            
                        </div>
                        <!--#########################数据列表#########################-->
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="1" class="ZB_List">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <td width="20"><w:thead title="模版名称" sortField="tempName" /></td>
                                        <td width="20"><w:thead title="模版内容" sortField="tempContent" /></td>
                                ...
                                <tbody>
                                    <s:iterator value="page.result" status="st">
                                        <tr onmouseover="this.style.backgroundColor='#DFE8F7'" onmouseout="this.style.backgroundColor=''">
                                            ...
                                            <input type="checkbox" name="checkItem" value="<s:property value="tempId" />" class="checkItem" /></td>
                                            <td><s:property value="tempName" />&nbsp;</td>
                                            <td><s:property value="tempContent" />&nbsp;</td>                                                                                
                                          
                  			            <td style="text-align: center;">
                                           		     <a title="修 改" href='expressageNoteTemp!input.action?tempId=<s:property value="tempId" />'>
