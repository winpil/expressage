...
public abstract class SimpleActionSupport extends CrudActionSupport {
 ...
 public HttpSession getSession() {
    ...
    * @throws IOException
    */
   public void writerMessageForJson(JSONObject jsonObject) throws IOException {
    ...
    * @throws IOException
    */
   public void writerMessageForJsonArray(JsonArray array) throws IOException {
		System.out.println("返回 ：" + array);
		HttpServletResponse response = getResponse();
		response.setContentType("text/html;charset=UTF-8");
		response.setCharacterEncoding("UTF-8");
		PrintWriter out = response.getWriter();
    ...
    * @throws IOException
    */
   public void writerMessageForInterface(String json) throws IOException {
		HttpServletResponse response = getResponse();
		response.setCharacterEncoding("utf-8");
		response.setContentType("text/html;charset=utf-8");
