...
public class MiSenderUtils1 {
	...
	private static final String APP_SECRET_KEY="VBZKmVPF/zEdkcFpDBU3oQ==";// APP_SECRET_KEY = appSecret 这东西(niaowanyi)是在开发者网站上注册时生成的, 可在应用详情下查看。
	private static final String MY_PACKAGE_NAME ="com.xgh.expresscourier";//设置app的包名packageName。packageName必须和开发者网站上申请的结果一致
