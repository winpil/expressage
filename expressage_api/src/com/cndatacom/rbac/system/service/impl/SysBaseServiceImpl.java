...
public class SysBaseServiceImpl extends BaseServiceImpl<SysBase, String> implements ISysBaseService{
	@Resource(name = "modelBaseHibernate")
	...
	public List getBaseApiList(SysBase sysBase,String paramenter1,String paramenter2,String paramenter3,String paramenter4,String paramenter5,String paramenter6,String pages,String pageSize) {
		return modelBaseDao.getBaseApiList(sysBase,paramenter1,paramenter2,paramenter3,paramenter4,paramenter5,paramenter6,pages,pageSize);
	}
}
