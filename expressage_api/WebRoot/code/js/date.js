...
(function ($) {
    $.fn.date = function (options,Ycallback,Ncallback) {
        ...
        var indexH=0,indexI=0,indexS=0;
        ...
        function bindButton(){
            ...
            $("#dateconfirm").unbind('click').click(function () {
                ...
                if(datetime){
                    if(Math.round(indexS)===1){//明天
                    	var nowDate = new Date();
                    	nowDate = new Date(nowDate.getTime()+10*240*600*60);
...
//                        $("#Hourwrapper ul li:eq("+indexH+")").html(parseInt($("#Hourwrapper ul li:eq("+indexH+")").html().substr(0,$("#Hourwrapper ul li:eq("+indexH+")").html().length-1)))
                    ...
                    console.log($("#Hourwrapper ul li:eq("+indexH+")").html())
                    datestr+=" "+$("#Hourwrapper ul li:eq("+indexH+")").html().substr(0,$("#Hourwrapper ul li:eq("+indexH+")").html().length-1)+":"+
        ...
        function CreateDateUI(){
            var str = ''+
                ...
                '<div id="datePage" class="page1" style="display:none">'+
        ...
        function createHOURS_UL(){
            ...
            return str+"<li style='height: 54px;'>&nbsp;</li>";;
        }
        //创建 --分-- 列表
