    ...
    <head>
        ...
        <script>
					...
					success : function(data) {
						if(data.code!='000000'){
	        				...
	        				for(var i=0;i<data.response.length;i++){
	        					...
	        					htmlStr+="<a href='/expressage_api/express/person_editor2.html?sta="+status+"&aId="+data.response[i].commonId+"'><div class='person-editor-icon'></div></a>";
			...
			function commons(commonsId){
				...
				if(status=='2'){
					window.location.href="/expressage_api/rbac/sys/expressageOrder/saveOrderByweixin?type=6&jId="+commonsId+"&openId="+openId;
				}else{
        	...
        	function newAddress(){
				window.location.href="/expressage_api/express/person_editor2.html";        	
        	}
        </script>
    </head>
    <body>
		...
		<div class="send-foot" style="position: absolute;bottom: 4%;">
			<button id="new-fhzd" value="" onclick="newAddress()" style="background-color: orange;">新增发货地址</button>
