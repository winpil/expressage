    ...
    <head>
        ...
        <script>
					...
					success : function(data) {
						if(data.code!='000000'){
	        				...
	        				for(var i=0;i<data.response.length;i++){
	        					...
	        					htmlStr+="<a href='/expressage_api/express/person_editor3.html?sta="+status+"&aId="+data.response[i].commonId+"'><div class='person-editor-icon'></div></a>";
			...
			function commons(commonsId){
				...
				if(status=='2'){
					window.location.href="/expressage_api/rbac/sys/expressageOrder/saveOrderByweixin?type=6&sId="+commonsId+"&openId="+openId;
				}else{
					window.location.href="/expressage_api/rbac/sys/expressageOrder/saveOrderByweixin?type=1&sId="+commonsId+"&openId="+openId;
				}
        	...
        	function newAddress(){
				window.location.href="/expressage_api/express/person_editor3.html";        	
        	}
        </script>
    </head>
    <body>
